// # creates a variable equal to all the gallery images
...
if (galleryImages) {
    galleryImages.forEach(function (image, index) {
        image.onclick = function () {
            ...
            newImg.setAttribute("src", "website/img/" + setNewImgUrl);
            newImg.setAttribute("id", "current-img");

            newImg.onload = function () {
                let imgWidth = this.width;
                let calImgToEdge = ((windowWidth - imgWidth) / 2) - 100;
                ...
                newPrevBtn.style.cssText = "left: " + calImgToEdge + "px;";
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "website/img/img" + calcNewImg + ".jpeg")
    newImg.setAttribute("id", "current-img")
